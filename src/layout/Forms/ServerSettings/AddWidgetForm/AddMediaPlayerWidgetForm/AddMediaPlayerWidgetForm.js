...
export const AddMediaPlayerWidgetForm = () => {
    ...
    return (
        <>
        <Header level={4} text='Add Media Player' />
        <Label label="The Media Player Widget lets you and your fellow channel dwellers watch videos together in perfect sync — whether it's a music drop, meme binge, or late-night documentary dive. Press play, sit back, and vibe out as a group. It's like a virtual couch, minus the popcorn crumbs." />
