...
export const ProfileImage = ({userImage, userBanner, getNewUserImage, getNewUserBanner, shape, color}) => {
    ...
    return (
        <div className='profile-image-container'>
            ...
            <ImageInput backgroundColor={accentColor} maxDimensions={250} getFile={getNewUserImage} initalImage={userImage} zIndex='1' width={"150px"} height={"150px"} borderRadius={shape === 'circle' ? '50%' : '10px'} />
        </div>
    )
}
