export const themes = {
  ...
  black: {
    ...
    '--input-background-color': '#000000ff',
    '--text-color': '#e5e5e5',
  ...
  bubbleDrift: {
    ...
    // darker of the gradient stops (#0f172a)
  ...
  midnightSunset: {
    ...
    // darker of the gradient stops (#0d0b1a)
    '--input-background-color': '#0d0b1a',
    '--text-color': '#f8fafc',
    '--button-background': '#3b82f6',
    '--button-hover': '#2563eb',
    '--error-color': '#f87171',
  ...
  obsidianSky: {
    ...
    // darker of the gradient stops (choose the deepest: #0f172a)
    '--input-background-color': '#0f172a',
    '--text-color': '#dbeafe',
    '--button-background': '#3b82f6',
    '--button-hover': '#2563eb',
