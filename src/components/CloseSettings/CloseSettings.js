...
export const CloseSettings = () => {
    ...
    const escapeMenu = (e) => {
        ...
        if (e.key === 'Escape') {
            ...
            if (location.includes('appsettings')) {
                
                window.location.hash = location.split('/appsettings')[0];
            
            } else if (location.includes('server-settings')) {
    ...
    return (
        <div onClick={() => {escapeMenu({key: 'Escape'})}} className='close-settings-container'>
