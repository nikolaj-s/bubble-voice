...
export const LeaveServerButton = ({action, width, height, id, padding, borderRadius, description, margin, invert}) => {
    ...
    return (
        <ButtonAnimationWrapper altInvert={true} margin={margin} invert={invert} padding={padding} description={description} borderRadius={borderRadius} width={width} height={height} id={id} action={action} >
