...
export const ServerMediaButton = ({active, action, transparent}) => {

    const textColor = useSelector(selectTextColor);

    return (
        <ButtonAnimationWrapper transparent={transparent} action={action} description={"Server Media"} altInvert={!active} borderRadius='0' padding={0} height={35} >
