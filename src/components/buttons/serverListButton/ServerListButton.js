...
export const ServerListButton = ({action, active}) => {
  ...
  return (
    <ButtonAnimationWrapper width={120} height={20} active={active} borderRadius='0%' action={action} >
        <svg style={{filter: active ? 'contrast(400%)' : null}} width="30" height="30" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
