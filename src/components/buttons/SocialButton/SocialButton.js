...
export const SocialButton = ({action, width, padding, height, borderRadius, margin, zIndex, flip_description, desc_o_mouse_leave, o_mouseLeave}) => {

    const color = useSelector(selectTextColor)

    return (
        <ButtonAnimationWrapper o_mouseLeave={o_mouseLeave} desc_o_mouse_leave={desc_o_mouse_leave} flip_description={flip_description} zIndex={zIndex} padding={padding} description={"Social"} margin={margin} width={width} height={height} action={action} borderRadius={borderRadius}>
