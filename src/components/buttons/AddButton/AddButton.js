...
export const AddButton = ({action, width = 30, height = 30, margin, description, borderRadius, o_mouseEnter, o_mouseLeave}) => {
    ...
    return (
        <ButtonAnimationWrapper o_mouseEnter={o_mouseEnter} o_mouseLeave={o_mouseLeave} borderRadius={borderRadius} description={description} margin={margin} width={width} height={height} action={action}>
            <svg 
            width="30" height="30" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg">
