...
export const AddButton = ({action, width = 30, height = 30, margin, description, borderRadius}) => {

    const color = useSelector(selectTextColor);

    return (
        <ButtonAnimationWrapper borderRadius={borderRadius} description={description} margin={margin} width={width} height={height} action={action}>
            <svg 
