...
import { selectActivationColor, selectSecondaryColor, selectTextColor } from '../../../../features/settings/appSettings/appearanceSettings/appearanceSettingsSlice'
...
export const ShareScreenButton = ({action, state, active, loading, id, width = 25, height = 25, padding, desc_space, sharing_screen}) => {
  ...
  return (
    ...
    zIndex={2}
    background={sharing_screen ? activationColor : secondaryColor}
    borderRadius={5}
    desc_width='100px'
    >
