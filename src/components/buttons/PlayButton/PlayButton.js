...
export const PlayButton = ({action, width = 35, height = 35, padding, borderRadius}) => {

    const color = useSelector(selectTextColor);

    return (
        <ButtonAnimationWrapper padding={padding} width={width} height={height} action={action} description={"Play"} borderRadius={borderRadius}>
