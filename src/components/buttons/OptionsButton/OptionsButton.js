...
export const OptionsButton = ({ctx = true, action, width, height, desc_width, transparent, altInvert, invert, description, right_orientation_desc, target, borderRadius, zIndex, top, left, }) => {
