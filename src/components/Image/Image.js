...
export const Image = ({image, objectFit = 'cover', position = 'relative', zIndex = 0, loadingState = '', opacity = 1}) => {
    ...
    return (
        <div style={{zIndex: zIndex, position: position, objectFit: objectFit, width: '100%', height: '100%', opacity: opacity}}>
