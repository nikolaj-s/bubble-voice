...
export const NoMedia = ({alt = false, message}) => {
    ...
    return (
        <div className='no-media-container'>
            ...
            <path d="M2 2L22 22.5" stroke={textColor} strokeWidth="2" strokeLinecap="round"/>
            </svg>
            
                
            : <svg width="200" height="200" viewBox="0 0 150 150" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M56.25 56.25L100 100H81.25V125L75 143.75L68.75 125V100H37.5V81.25L56.25 62.5V56.25ZM106.25 12.5V25L93.75 31.25V62.5L112.5 81.25V96.6313L76.6875 60.8125L56.25 40.375V31.25L43.75 25V12.5H106.25Z" fill={textColor}/>
            <path d="M14.1875 14.1875L6.25 22.125L127.875 143.75L135.812 135.812L68.75 68.75L14.1875 14.1875Z" fill={textColor}/>
            </svg>}
