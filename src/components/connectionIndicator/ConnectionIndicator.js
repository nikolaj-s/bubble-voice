...
export const ConnectionIndicator = ({active}) => {
    ...
    return (
        <ButtonAnimationWrapper altInvert={true} borderRadius={5} invert={false} action={active ? handleToggleShowPing : () => {}} zIndex={1} description={active ? `${ping}ms` : null} opacity={active ? 1 : 0.2} width={25} height={25} position={'relative'} active={!active} >
            {ping === 0 ?
